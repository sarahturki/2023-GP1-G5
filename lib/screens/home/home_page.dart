...
Widget dateCustom(
  ...
  return Container(
    ...
    decoration: BoxDecoration(
       border: Border.all(
                    color: Color.fromARGB(255, 250, 179, 207),
                    width: 1,
                  ) ,
      color: color!,
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(child: Image.asset("assets/logo-removebg-preview 4.png"))
            ],
          ),
        ),
        Column(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Directionality(
                        ...
                        child: Text( 
                          titlesss, textAlign: TextAlign.right,
                          style: const TextStyle(
                              fontSize: 18, color: Color(0xff8C8A8A),   ),  
                        ),
                      ),
                      const SizedBox(
                        width: 24.0,
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: ListTile(
                        title: const Text("طول الطفل" , textAlign: TextAlign.center),
                        subtitle: Text(
                          currentWeeklyInfo!.forHeight  + "سم" ,textAlign: TextAlign.center ,
                    ...
                    Directionality(
                      ...
                      child: Expanded(
                        child: ListTile(
                          title: const Text("وزن الطفل" , textAlign: TextAlign.center),
                          subtitle: Text(
                            currentWeeklyInfo!.forWeight   +" جم",  textAlign: TextAlign.center ,
                            style: const TextStyle(fontSize: 14),
                          ),
                        ),
                      ),
                    ...
                    Expanded(
                      child: ListTile(
                        title: const Text("الايام المتبقية" , textAlign: TextAlign.center,),
                        subtitle: Text(
                           " $remainDays ", textAlign: TextAlign.center , textDirection: TextDirection.rtl,
                          style: const TextStyle(fontSize: 14),
                        ),
                      ),
                    ),
              ...
              child: Column(
                children: [
                  ...
                  Directionality(
                    textDirection: TextDirection.rtl,
                    child: Text(
                       displayText, textDirection: TextDirection.rtl,
              ...
              child: Column(
                children: [
                  ...
                  Directionality(
                    textDirection: TextDirection.rtl ,
                    child: Text(
                     forbaby , textDirection: TextDirection.rtl,
                      textAlign: TextAlign.right,
                      style: const TextStyle(
                        fontSize: 16,
                      ),
